...
async function switchPanel(name, opts = {}) {
  ...
  if (mainEl) {
    ['settings','skills','memory','tasks','kanban','workspaces','profiles','insights','logs','plugin','social','agents','floor','reporting','admin'].forEach(p => {
...
function switchSettingsSection(name){
  ...
  if (_currentPanel !== 'settings') {
    ...
    if (mainEl) {
      ['settings','skills','memory','tasks','kanban','workspaces','profiles','insights','logs','plugin','social','agents','floor','reporting','admin'].forEach(function(p) {
