...
def _client_soul(email: str, gologin_pid: str) -> str:
    return (
        ...
        "## Self-learning (get faster every run, stop hitting walls)\n"
        "Your browser has a per-platform MEMORY. The `post` command automatically remembers the "
        "selectors that worked and reuses them next time (fast path), only re-discovering when the "
        "site changed. BEFORE you act on a platform, recall what you learned:\n"
        ...
        "Read your notes, apply them, and only add a note when you learn something genuinely new.\n\n"
        "## Content creation\n"
